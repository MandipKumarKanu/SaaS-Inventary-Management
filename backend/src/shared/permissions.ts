...
export const DEFAULT_ROLE_PERMISSIONS: Record<string, string[]> = {
  ...
  Manager: [
    ...
    PERMISSIONS.PURCHASES_VIEW, PERMISSIONS.PURCHASES_CREATE, PERMISSIONS.PURCHASES_APPROVE, PERMISSIONS.PURCHASES_RECEIVE,
    PERMISSIONS.SALES_VIEW, PERMISSIONS.SALES_CREATE, PERMISSIONS.SALES_RESERVE, PERMISSIONS.SALES_FULFILL, PERMISSIONS.SALES_CANCEL,
    PERMISSIONS.TRANSFERS_VIEW, PERMISSIONS.TRANSFERS_CREATE, PERMISSIONS.TRANSFERS_APPROVE, PERMISSIONS.TRANSFERS_SHIP, PERMISSIONS.TRANSFERS_RECEIVE,
    PERMISSIONS.RETURNS_VIEW, PERMISSIONS.RETURNS_CREATE, PERMISSIONS.RETURNS_APPROVE, PERMISSIONS.RETURNS_INSPECT, PERMISSIONS.RETURNS_RESTOCK,
  ...
  'Purchasing Staff': [
    ...
    PERMISSIONS.WAREHOUSES_VIEW,
    PERMISSIONS.PURCHASES_VIEW, PERMISSIONS.PURCHASES_CREATE, PERMISSIONS.PURCHASES_RECEIVE,
